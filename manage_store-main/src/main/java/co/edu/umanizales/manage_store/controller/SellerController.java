...
public class SellerController {
    ...
    @GetMapping(path = "/reportquantity/{code}")
    public ResponseEntity<ResponseDTO> getReportOfQuantityBySeller(@PathVariable int code) {
        return new ResponseEntity<>(new ResponseDTO(200, sellerService.getSellerByQuantity(code), null), HttpStatus.OK);
    }
}
